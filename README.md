...
<p align="center"> پلاگین ادیوری برای موتور بازی سازی گودو (سازنده اصلی DexterFstone است) </p>
...
برای دریافت پلاگین ادیوری، از [Release نسخه 4.7.2](https://github.com/fattahstudio/godot-adivery/releases/tag/4.7.2) استفاده کنید.

## نصب ادیوری

* ابتدا ادیوری را از [Release نسخه 4.7.2](https://github.com/fattahstudio/godot-adivery/releases/tag/4.7.2) دریافت کنید.
* فایل ZIP دریافت‌شده را استخراج کنید.
* فایل استخراج‌شده را در محل پروژه خود کپی کنید.
* از منوی `Project` وارد قسمت `Project Settings` شوید و سپس به تب `Plugins` بروید.
